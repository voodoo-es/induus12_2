...
class WebsiteSale(WebsiteSale):
    ...
    def my_invoice_address(self, **kw):
        ...
        # IF ORDER LINKED TO A PARTNER
            ...
            if values and values.zona_id:
                values.update({'zona_id': values.zona_id.id})
        elif partnerId == -1:
            addrMode = ('new', 'billing')
        ...
        if 'submitted' in kw:
            ...
            if errors:
                ...
                try:
                    ...
                    errors.update({'error_message': [str(e.args[0])]})
...
class CustomerPortal(CustomerPortal):
    ...
    def my_address(self, **kw):
        ...
        country = 'country_id' in partnerObj and partnerObj['country_id'] != '' and countryModel.browse(int(partnerObj['country_id']))
        country = country and country.exists() or defCountryId
        renderValues = {
            'partner_id': partnerId,
