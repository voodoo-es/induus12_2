                            ...
                            if useServerRewrites:
                                ...
                                if redirect:
                                    ...
                                    if rewrite_val == 'product.template':
                                        _logger.warning("es un rewrite_val")
